...
const Drawer = ({ children, isOpen, onClose }: IProps) => {
  return (
    <div className={clsx("w-full h-full fixed inset-0 z-[17] transition-opacity duration-300", isOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none")}>
      {/* Overlay */}

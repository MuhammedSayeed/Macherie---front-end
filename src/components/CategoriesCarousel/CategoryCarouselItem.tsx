...
const CategoryCarouselItem = ({ item }: IProps) => {
  return (
    <CarouselItem className="pl-2 rounded-lg md:pl-4 basis-[280px] sm:basis-[320px] md:basis-1/2 lg:basis-1/3 xl:basis-1/4 overflow-hidden hover:basis-[400px] transition-all duration-500 ease-in-out">
